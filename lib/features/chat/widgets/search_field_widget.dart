...
class SearchFieldWidget extends StatefulWidget {
  ...
  const SearchFieldWidget({Key? key, required this.controller, required this.hint, required this.suffixIcon, required this.iconPressed, this.onSubmit, this.onChanged}) : super(key: key);
