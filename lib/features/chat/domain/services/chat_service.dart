...
import 'package:sixvalley_delivery_boy/features/chat/domain/repositories/chat_repository_interface.dart' show ChatRepositoryInterface;
...
class ChatService implements ChatServiceInterface{
  ...
  @override
  Future sendMessage(message, userId, files) async{
    String userType = 'admin';
    if(userId == 0){
      userType = 'admin';
    }else{
    ...
    Response _response = await chatRepoInterface.sendMessage(message, userId, userType, files);
